...
```sh
firejail env PROTONPATH=~/.var/app/com.heroicgameslauncher.hgl/config/heroic/tools/proton/GE-Proton-latest/ env PROTON_ENABLE_WAYLAND=1 env WINEPREFIX=/mnt/09403f3c-3c66-47f2-a0b4-5b5fbae04d23/home/twig/Games/DefaultPrefix/
```
